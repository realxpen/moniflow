...
const styles = StyleSheet.create({
  ...
  operatorPrompt: { color: palette.ink, fontSize: 20, lineHeight: 26, fontWeight: "600", marginTop: 8, marginBottom: 14 },
  ...
  sectionHeadline: { color: palette.ink, fontSize: 36, lineHeight: 41, fontWeight: "600", letterSpacing: -1.6, maxWidth: 880, marginTop: 14 },
  ...
  quote: { color: palette.ink, fontSize: 24, lineHeight: 32, fontWeight: "600", letterSpacing: -0.8, marginBottom: 24 },
  ...
  guardTitle: { color: "#FFFFFF", fontSize: 30, lineHeight: 36, fontWeight: "600", letterSpacing: -1.2, marginTop: 8, maxWidth: 560 },
  ...
  futureTitle: { color: palette.ink, fontSize: 24, lineHeight: 30, fontWeight: "600", letterSpacing: -0.8, marginTop: 18 },
  ...
  visionTitle: { color: palette.ink, textAlign: "center", fontSize: 40, lineHeight: 45, fontWeight: "600", letterSpacing: -1.8, maxWidth: 1050 },
